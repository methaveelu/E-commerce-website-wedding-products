    ...
    >
      <div className={`${styles.section} w-[90%] 800px:w-[60%]`} style={{ backgroundColor: "rgba(255, 255, 255, 0.8)" }}>
        <h1
          ...
          style={{ fontFamily: "'Great Vibes', sans-serif", fontWeight: "bold" }}
        >
          Best Collection for <br /> Wedding Essentials
        </h1>
        <p className="pt-5 text-[16px] font-Quintessential font-medium text-[#4b5563]" style={{ fontFamily: "'Quintessential', sans-serif" }}>
          Make your special day unforgettable with our wedding collection!
        </p>
        <Link to="/products" className="inline-block">
          <div className={`${styles.button} mt-5 bg-pink-400`} style={{ fontFamily: "'Poppins', sans-serif" }}>
